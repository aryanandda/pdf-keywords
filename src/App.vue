      ...
      <Stepper @step-change="stepChanged">
          ...
          <StepperPanel header="File PDF">
              <template #content="{ prevCallback, nextCallback }">
                  <div class="card">
                      <FileUpload name="files" url="http://http://45.13.132.133:8000/upload" @upload="onUploadCompleted($event)" @before-send="onBeforeSend($event)" @error="onUploadError($event)" :multiple="true" accept="application/pdf">
                          <template #empty>
...
const submit = (next) => {
  ...
  axios.post('http://http://45.13.132.133:8000/submit', {
